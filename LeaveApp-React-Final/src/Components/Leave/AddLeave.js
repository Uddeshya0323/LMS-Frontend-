...
export default class AddLeave extends React.Component{
        ...
        saveLeaves = async (e) =>
        {
            ...
            try {
                ...
                const result= await axios.post('http://localhost:49315/api/Employees/'+email)
                .then(res=> { 
                    alert(res.data)
                    EmpId=res.data;
                    console.log(EmpId)
            ...
            axios.post('http://localhost:49315/api/Logins/'+localStorage.getItem('EmpId'))
            .then(res=> { 
               // alert(res.data)
                Mgr=res.data;
            ...
            const result=await axios.post('http://localhost:49315/api/Leaves',          
            {           
