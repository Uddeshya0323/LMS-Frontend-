...
export default class ADL extends React.Component
{
      ...
      componentDidMount()
    {
        ...
        try {
            const result=  axios.post('http://localhost:49315/api/Managers/'+MgrEmail)
            .then(res=> { 
               // alert(res.data)
                mgr_Id=res.data;
       ...
       // alert(EmpId);
         axios.post('http://localhost:49315/api/Leaves/'+MgrId)
       .then((res) =>{  
                ...
                <table className='table table-striped table-bordered'>
     ...
     
                    {
                        ...
                        <td><button onClick={function Approve(){
                            ...
                            console.log(l.lid);
                            const result=axios.put("http://localhost:49315/api/Leaves/"+l.lid,
                            {
                                "lid":l.lId,
                                "empID":l.empID,
                                "manID":l.manID,
